...
image_urls = [
    "https://i.ibb.co/4wRW2pv4/photo-2025-04-12-02-55-49-7492255008293912596.jpg",
    "https://i.ibb.co/4wRW2pv4/photo-2025-04-12-02-55-49-7492255008293912596.jpg",
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"**If you have any questions, feel free to ask [Dinc](https://t.me/Dinc05)! 💬**\n"
        )
    ) 
        ...
        for i in range(arg-1, len(links)):
            ...
            if "jw-prod" in url:
               ...
               cmd = f'yt-dlp --add-header "referer:https://web.classplusapp.com/" --add-header "x-cdn-tag:empty" -f "{ytf}" "{url}" -o "{name}.mp4"'
                ...
                cmd = f'yt-dlp --cookies youtube_cookies.txt {raw_text2} -f "{ytf}" "{url}" -o "{name}".mp4'
            else:
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [Dinc](https://t.me/dinc05)"
